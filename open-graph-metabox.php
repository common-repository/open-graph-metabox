			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
                        ...
                        <input type='button' class="button-primary open_graph_image" data-target="#open_graph_image_value" value="<?php esc_attr_e( 'Select image', 'open-graph-metabox' ); ?>" id="open_graph_image"/>
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							<input type="button" class="button-primary open_graph_image" data-target="#open_graph_image_value" id="open_graph_image" value="<?php _e('Select image', 'open-graph-metabox'); ?>">
						</td>
					</tr>
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							<input type="button" class="button-primary open_graph_image" data-target="#home_open_graph_image_value" id="home_open_graph_image" value="<?php _e('Select image', 'open-graph-metabox'); ?>">
						</td>
					</tr>
